...
class RecyclerSelService(private val service: MutableList<Services>):
    RecyclerView.Adapter<RecyclerSelService.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val itemView =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.recycler_sel_service, parent, false)
